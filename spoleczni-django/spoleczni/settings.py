"""
Django settings for spoleczni project.
...
SECRET_KEY = 'z*epxu%v#x=y#8k$3do#3!1a)cux$$al2a3&nn_hwa=nzol7h('
...
ROOT_URLCONF = 'spoleczni.urls'

WSGI_APPLICATION = 'spoleczni.wsgi.application'
